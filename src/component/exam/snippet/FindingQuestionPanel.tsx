import { ExamQuestionFinding } from '@/api';
...
const FindingQuestionPanel = ({ question, maxOccurrence, totalOccurrence, answer, isCorrect }: QuestionPanelProps) => {
...
export default FindingQuestionPanel;
