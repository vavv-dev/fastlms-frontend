...
import {
  ...
  SurveyGetSurveyReportData as GetReportData,
  SurveyReportResponse as ReportResponse,
  surveyDownloadSurveyReport as downloadReport,
  surveyGetSurveyReport as getReport,
} from '@/api';
