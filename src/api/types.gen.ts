...
export type ChannelContentResponse = {
    ...
    asset?: Array<AssetDisplayResponse>;
    quiz?: Array<QuizDisplayResponse>;
...
export type LearningResourceKind = 'video' | 'playlist' | 'short' | 'quiz' | 'survey' | 'exam' | 'asset' | 'lesson' | 'course' | 'group' | 'post';
...
export type LessonEmbedResource = {
    kind: 'video' | 'asset' | 'quiz' | 'survey' | 'exam';
    id: string;
    title: string;
    thumbnail: string;
};
...
export type LessonResourceSelectorResponse = {
    kind: 'quiz' | 'asset' | 'survey' | 'video' | 'exam';
    id: string;
    title: string;
    thumbnail: string;
};
...
export type QuizResourceCreateRequest = {
    ...
    start_date: string;
    end_date: (string | null);
    resources: (Array<QuizEmbedResource> | null);
    success_message: string;
    failure_message: string;
    cutoff_percent: number;
    randomize: boolean;
...
export type SurveyEmbedResource = {
    kind: 'video';
    id: string;
    title: string;
    thumbnail: string;
...
export type SurveyResourceCreateRequest = {
    ...
    start_date: string;
    end_date: (string | null);
    resources: (Array<SurveyEmbedResource> | null);
...
export type AssetEndWatchData = {
    accessToken?: (string | null);
    id: string;
    refreshToken?: (string | null);
};

export type AssetEndWatchResponse = (unknown);
